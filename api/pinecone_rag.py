...
PDF_FILE = "assets/hackathon-doc.pdf"  # Your story file
...
def read_pdf(file_path):
    """Extracts text from a PDF file, skipping the first 8 pages and the last 2 pages"""
    ...
    with open(file_path, "rb") as pdf_file:
        ...
        for i in range(8, total_pages - 2):
...
def store_in_pinecone():
    ...
    # Upsert vectors in batches to avoid exceeding the size limit
